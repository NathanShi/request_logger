...
Everyone interacting in the RequestLog project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/request_logger/blob/master/CODE_OF_CONDUCT.md).
